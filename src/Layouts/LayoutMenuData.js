...
const Navdata = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subItems: [
                // ... all other Apps subItems except Ecommerce
                {
                    id: "appsecommerce",
                    label: "Ecommerce",
                    link: "/#",
                    ...
                    childItems: [
                        ...
                        { id: 11, label: "Sellers", link: "/apps-ecommerce-sellers", parentId: "apps" },
                        { id: 12, label: "Seller Details", link: "/apps-ecommerce-seller-details", parentId: "apps" },
                    ]
                },
                // ... potentially other Apps subItems commented out
            ],
        },
        // ... other main menu items like Authentication, Pages, etc.
        */
        // Only Ecommerce section is active below
        {
            id: "apps",
            label: "Apps",
            icon: "ri-apps-2-line",
